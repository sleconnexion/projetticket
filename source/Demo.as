package
{
    ...
    public class Demo extends Sprite
    {
		...
		[Embed(source="../media/montest.pex", mimeType="application/octet-stream")]
		private static const MontestConfig:Class;
		...
		[Embed(source = "../media/montest_particle.png")]
		private static const MontestParticle:Class;
        ...
        public function Demo()
        {
			...
			var montestConfig:XML = XML(new MontestConfig());
			var montestTexture:Texture = Texture.fromBitmap(new MontestParticle());
            ...
            mParticleSystems = new <ParticleSystem>[
				...
				new PDParticleSystem(montestConfig, montestTexture),
		...
		public function getexplosion():ParticleSystem{
			var montestConfig:XML = XML(new MontestConfig());
			var montestTexture:Texture = Texture.fromBitmap(new MontestParticle());
			return new PDParticleSystem(montestConfig, montestTexture);
		}
